...
Just from an initial map view, it can be noted that areas where PM2.5 pollutants is the most preventable are not always areas that asthma levels are the highest. While both seem to be in higher numbers in more populated areas, like the bay area and L.A., PM2.5 appears to reach its highest levels in the central valley.
...
Below is a plot showing PM2.5 and asthma levels for the state of California with each tract represented by a dot. The plot also has a linear line of best fit.
